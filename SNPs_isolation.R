...
SNP_list_1_4 <- fread(input = "~/Documents/twins_ML_project/plink/1-4-T23-gwa610K.output.raw")  # Load the plink data
SNP_list_1_4 <- SNP_list_1_4[, grep("HET", colnames(SNP_list_1_4)):=NULL]  # Remove the HET columns (cut dataframe size in half)
SNP_Fcell_test <- fread(input = "~/Twins/FID_ID_FCellFACS.csv")  # Load fcell level information
SNP_merged_test <- merge(x = SNP_list_1_4, y = SNP_Fcell_test, by = "IID")  # Add the fcell information to the SNP data
...
(2*round(dim(SNP_merged_test)[2]/3))
round(dim(SNP_merged_test)[2]/3)+1
...
saveRDS(SNP_merged_test_Twin1, file = "~/Documents/twins_ML_project/plink/ML_project/1-4_SNP_merged_test_Twin1_part2.rds")  # Save locally as compact rds file
saveRDS(SNP_merged_test_Twin2, file = "~/Documents/twins_ML_project/plink/ML_project/1-4_SNP_merged_test_Twin2_part2.rds")  # Save locally as compact rds file

SNP_merged_test_Twin1 <- readRDS(file = "~/Documents/twins_ML_project/plink/ML_project/1-4_SNP_merged_test_Twin1_part1.rds")
SNP_merged_test_Twin2 <- readRDS(file = "~/Documents/twins_ML_project/plink/ML_project/1-4_SNP_merged_test_Twin2_part1.rds")
...
# Is the data being clipped?
data.table::fwrite(x = Twins1_SNPs_fcell_train, file = "/home/callumrakhit/Documents/twins_ML_project/plink/ML_project/Twins1_SNPs_fcell_train_part2.csv")
data.table::fwrite(x = Twins1_SNPs_fcell_test, file = "/home/callumrakhit/Documents/twins_ML_project/plink/ML_project/Twins2_SNPs_fcell_test_part2.csv")

train.h2o <- h2o.importFile(path = "/home/callumrakhit/Documents/twins_ML_project/plink/ML_project/Twins1_SNPs_fcell_train_part2.csv")
test.h2o <- h2o.importFile(path = "/home/callumrakhit/Documents/twins_ML_project/plink/ML_project/Twins2_SNPs_fcell_test_part2.csv")
...
saveRDS(object = grid, file = "~/Documents/twins_ML_project/plink/ML_project/rf_1.rds")

# Load model
grid <- readRDS("~/Documents/twins_ML_project/plink/ML_project/rf_1")
...
write_csv(x = as.data.frame(rf_1_top_100_predictors), path = "~/Documents/twins_ML_project/plink/ML_project/rf_1_top100.csv")
